...
struct OsResource OsResource2_OsResource = {
		RESOURCE_STANDARD,	//OsResourceProperty OsResourceProperty;	
		//		//struct OsApplication * OsApplicationAccessingApplication;
		NULL,	//struct OsResource * OsResourceLinkedResourceRef;	
		NULL		//struct OsResourceXenomai * OsResourceXenomai;		/*!< Xenomai implementation for a Resource */};
...
struct OsResource OsResource3_OsResource = {
		RESOURCE_LINKED,	//OsResourceProperty OsResourceProperty;	
		//		//struct OsApplication * OsApplicationAccessingApplication;
		&OsResource1_OsResource,	//struct OsResource * OsResourceLinkedResourceRef;	
		NULL		//struct OsResourceXenomai * OsResourceXenomai;		/*!< Xenomai implementation for a Resource */};
};
/*********************** Resource OsResource4 ***********************/
struct OsResource OsResource4_OsResource = {
		RESOURCE_INTERNAL,	//OsResourceProperty OsResourceProperty;	
		//		//struct OsApplication * OsApplicationAccessingApplication;
		NULL,	//struct OsResource * OsResourceLinkedResourceRef;	
		NULL		//struct OsResourceXenomai * OsResourceXenomai;		/*!< Xenomai implementation for a Resource */};
};
...
struct OsResource * OsResource_table[RESOURCE_COUNT] = {
	...
	&OsResource2_OsResource,
	&OsResource3_OsResource,
	&OsResource4_OsResource,
};

/*********************** Task OsTask3 ***********************/
extern void OsTask3_function(void);
struct OsResource * OsTask3_OsTaskResourceRef[OsTask3_RESOURCE_COUNT] = {
	&OsResource2_OsResource,
	&OsResource3_OsResource,
};
...
struct OsTask OsTask3_OsTask = {
	...
	50,		//	EcucIntegerParamDef OsTaskPriority;
	...
	OsTask3_OsTaskResourceRef,	//	struct OsResource ** OsTaskResourceRef;	
...
struct OsTask OsTask2_OsTask = {
	1,	//	EcucIntegerParamDef OsTaskActivation;
	30,		//	EcucIntegerParamDef OsTaskPriority;
	TASK_NON,	//	EcucEnumerationParamDef OsTaskSchedule; NON or FULL preempt
	//											//	struct OsApplication * OsTaskAccessingApplication;
	//											//	struct OsEvent * OsTaskEventRef;
