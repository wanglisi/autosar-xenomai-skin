...
/* config */
#define CONFIG_XENO_BUILD_ARGS " '--target=arm-buildroot-linux-uclibcgnueabihf' '--host=arm-buildroot-linux-uclibcgnueabihf' '--build=x86_64-pc-linux-gnu' '--prefix=/usr' '--exec-prefix=/usr' '--sysconfdir=/etc' '--localstatedir=/var' '--program-prefix=' '--disable-gtk-doc' '--disable-gtk-doc-html' '--disable-doc' '--disable-docs' '--disable-documentation' '--with-xmlto=no' '--with-fop=no' '--disable-dependency-tracking' '--enable-ipv6' '--disable-nls' '--disable-static' '--enable-shared' '--with-core=cobalt' '--includedir=/usr/include/xenomai/' '--disable-doc-install' '--enable-lores-clock' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=arm-buildroot-linux-uclibcgnueabihf' 'target_alias=arm-buildroot-linux-uclibcgnueabihf' 'CC=/home/aulef/Documents/Xenomai_BR_installlib/buildroot-2016.08/output/host/usr/bin/arm-buildroot-linux-uclibcgnueabihf-gcc' 'CFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  -Os ' 'LDFLAGS=' 'CPPFLAGS=-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64' 'CPP=/home/aulef/Documents/Xenomai_BR_installlib/buildroot-2016.08/output/host/usr/bin/arm-buildroot-linux-uclibcgnueabihf-cpp' 'PKG_CONFIG=/home/aulef/Documents/Xenomai_BR_installlib/buildroot-2016.08/output/host/usr/bin/pkg-config'"
...
/* Compiler */
#define CONFIG_XENO_COMPILER "gcc version 4.9.4 (Buildroot 2016.08) "
...
/* Host system alias */
#define CONFIG_XENO_HOST_STRING "arm-buildroot-linux-uclibcgnueabihf"

/* config */
/* #undef CONFIG_XENO_LIBS_DLOPEN */

/* config */
/* #undef CONFIG_XENO_LORES_CLOCK_DISABLED */
...
#define PACKAGE_STRING "Xenomai 3.0.2"
